...
return [
    ...
    'list_demo'=>[
        [
            'url'=>'https://resortbazar.com',
            'name'=>'Homepage',
            'thumb'=>'img/demo/home.png',
        ],
        [
            'url'=>'https://resortbazar.com/tour',
            'name'=>'Tour Search',
            'thumb'=>'img/demo/tour.png'
        ],
        [
            'url'=>'https://resortbazar.com/tour/paris-vacation-travel',
            'name'=>'Single Tour',
            'thumb'=>'img/demo/tour_single.png'
        ],
        [
            'url'=>'https://resortbazar.com/en/page/space',
            'name'=>'Home Space',
            'thumb'=>'img/demo/home-space.png',
        ],
        [
            'url'=>'https://resortbazar.com/en/space',
            'name'=>'Space Search',
            'thumb'=>'img/demo/space-search.png'
        ],
        [
            'url'=>'https://resortbazar.com/en/space/stay-greenwich-village',
            'name'=>'Single Space',
            'thumb'=>'img/demo/single-space.png'
        ],
        [
            'url'=>'https://resortbazar.com/tour?_layout=map',
            'name'=>'Search Map',
            'thumb'=>'img/demo/tour_map.png',
            'class'=>'col-lg-8 col-md-12 col-sm-12'
        ],
        [
            'url'=>'https://resortbazar.com/news',
            'name'=>'Blog List',
