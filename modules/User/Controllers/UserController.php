...
class UserController extends FrontendController
{
    ...
    public function boatBookingHistory()
    {
        $user_id = Auth::id();
        $data = [
            'boatBooking' => BoatBooking::where('user_id', $user_id)->with('boatBookingCabin')->get(),
            'breadcrumbs' => [
               [
                 'name' => __('Boat Booking History'),
                'class' => 'active'
               ]
            ],
            'page_title' => __("Boat Booking History"),
        ];
        return view('User::frontend.boatBookingHistory', $data);
    }
