...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">Feature Edit</h1>
        ...
        <div>
            <div class="panel">
                <div class="panel-body">
                    <form action="{{ route('feature.admin.update', $feature->id) }}" class="bravo-form-item" method="POST"
                        ...
                        <div class="row">
                                ...
                                <select name="boat_id" id="" class="form-select">
                                    ...
                                    @foreach ($boats as $key => $boat)
                                        <option value="{{ $boat->id }}"
                                            @if ($boat->id == $feature->boat_id) selected @endif>{{ $boat->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" name="title" class="form-control "
                                    placeholder="please enter your title" value="{{ $feature->title ?? '' }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                <input type="checkbox" name="status" class="form-control" value="1"
                                    @if ($feature->status == '1') checked @endif>
