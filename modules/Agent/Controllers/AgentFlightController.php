        ...
        public function index(Request $request)
        {
            ...
            if (!empty($list) and $for_map) {
                foreach ($list as $row) {
                    $markers[] = [
                        ...
                        "infobox" => view('Agent::frontend.Flight.layouts.search.loop-grid', ['row' => $row,'disable_lazyload'=>1,'wrap_class'=>'infobox-item'])->render(),
            ...
            if ($is_ajax) {
                return $this->sendSuccess([
                    "markers" => $markers,
                    'fragments'=>[
                        '.ajax-search-result'=>view('Agent::frontend.Flight.ajax.search-result'.($for_map ? '-map' : ''), $data)->render(),
