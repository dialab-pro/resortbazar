...
class AgentBookingSearchForm extends BaseBlock {

    public function getName(){
        return __('Search Form For Agent Booking');
    }
    ...
    public function content($model = [])
    {
        ...
        return $this->view('Agent::frontend.blocks.agent-booking.form-search', $model);
