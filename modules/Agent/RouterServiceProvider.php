...
class RouterServiceProvider extends ServiceProvider {
     ...
     * @var string
    */
    protected $adminModuleNamespace = 'Modules\Agent\Admin';
    protected $moduleNamespace = 'Modules\Agent\Controllers';
    ...
    */
    ...
    protected function mapAdminRoutes(){
        Route::middleware(['web','dashboard'])
            ...
            ->prefix(config('admin.admin_route_prefix').'/module/agent')
