...
class StripeCheckoutGateway extends BaseGateway
{
    ...
    {
        dd("process er vitore ashe", $request, $booking, $service);
        $this->setupStripe();
    ...
    public function tryCreateUser(Booking $booking){
        dd("try create user a aice a aice");
        $user = auth()->user();
    ...
    public function setupStripe(){
        dd("setup stripe a aice");
        \Stripe\Stripe::setApiKey($this->getSecretKey());
    }

    public function getPublicKey(){
        dd("get publickey a aice");
    ...
    {
        dd("confirm normal payment a aice");
        /**
         * @var Payment $payment
         */
        $request = \request();
