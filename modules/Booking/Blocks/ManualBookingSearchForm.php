...
class ManualBookingSearchForm extends BaseBlock {

    public function getName(){
        return __('Search Form For Manual Booking');
    }
    ...
    public function content($model = [])
    {
        ...
        return $this->view('Booking::admin.blocks.manual-booking-form-search', $model);
