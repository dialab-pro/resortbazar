            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-9">
                        ...
                        @include('Agent::frontend.Tour.layouts.details.tour-detail')
                    </div>
...
@push('js')
    ...
    <script type="text/javascript" src="{{ asset('module/agent/js/single-tour.js?_ver='.config('app.asset_version')) }}"></script>
