<div class="form-checkout" id="form-checkout" >
            ...
            <div class="col-12" style="margin-bottom:15px">
                ...
                @php
                    ...
                    \App\Helpers\AdminForm::select2('customer_id', [
                        'configs' => [
                            'ajax'        => [
                                'url'      => route('user.admin.getForSelect2', ['user_type'=>'user']),
                                'dataType' => 'json',
                            ],
                            'allowClear'  => true,
    ...
    @include ($service->checkout_form_payment_file ?? 'Booking::admin/booking/checkout-payment')
    ...
    <div class="form-group">
        <label class="term-conditions-checkbox">
            ...
            <a target="_blank" href="{{get_page_url($term_conditions)}}">
