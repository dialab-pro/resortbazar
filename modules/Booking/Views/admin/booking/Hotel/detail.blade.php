...
@push('js')
    ...
    <script type="text/javascript" src="{{ asset('libs/carousel-2/owl.carousel.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset("libs/daterange/moment.min.js") }}"></script>
    <script type="text/javascript" src="{{ asset("libs/daterange/daterangepicker.min.js") }}"></script>
    <script type="text/javascript" src="{{ asset('libs/select2/js/select2.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/functions.js?_ver='.config('app.asset_version')) }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('module/booking/admin/single-hotel.js?_ver='.config('app.asset_version')) }}"></script>
