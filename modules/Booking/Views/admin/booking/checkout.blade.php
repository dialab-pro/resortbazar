                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <h3 class="form-title">
                         ...
                         <div class="booking-form">
                             ...
                             @include($service->checkout_form_file ?? 'Booking::admin/booking/checkout-form')
                    ...
                    <div class="col-md-4">
                        <div class="booking-detail booking-form">
                            @include ($service->checkout_booking_detail_file_admin ?? '')
                        </div>
                    </div>
                </div>
            </div>
...
@push('js')
    <script src="{{ asset('module/booking/admin/checkout.js') }}"></script>

    <script type="text/javascript">
        jQuery(function () {
            $.ajax({
                'url': bookingCore.url + '{{$is_api ? '/api' : ''}}/agent/booking/{{$booking->code}}/check-status',
                'cache': false,
                'type': 'GET',
