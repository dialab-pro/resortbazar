...
class AdminManualHotelController extends Controller {
    ...
    */
    ...
    public function callAction($method, $parameters){
        if(!Hotel::isEnable()){
            return redirect('/admin/module/booking/manual/make');
        }
    ...
    public function index(Request $request){
        ...
        if ($for_map and !empty($list)) {
            foreach ($list as $row) {
                $markers[] = [
                    ...
                    "infobox" => view('Booking::admin.booking.Hotel.layouts.search.loop-grid', ['row' => $row,'disable_lazyload'=>1,'wrap_class'=>'infobox-item'])->render(),
        ...
        if ($is_ajax) {
            return $this->sendSuccess([
                "markers" => $markers,
                'fragments'=>[
                    '.ajax-search-result'=>view('Booking::admin.booking.Hotel.ajax.search-result'.($for_map ? '-map' : ''), $data)->render(),
        ...
        $type = 'manual_booking_search_form';
        ...
        return view('Booking::admin/booking/create', $data);

    }

    public function detail(Request $request, $slug){

        $row = $this->hotelClass::where('slug', $slug)->with(['location','translation','hasWishList','rooms'])->first();;
        ...
        return view('Booking::admin.booking.Hotel.detail', $data);
    }
