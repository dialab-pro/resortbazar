...
class BookingController extends AdminController {
    ...
    public function __construct(Booking $booking, Enquiry $enquiryClass){
        ...
        $this->setActiveMenu(route('booking.manual'));
    }
...
/**
    ...
    public function checkout($code) {
        ...
        return view('Booking::admin/booking/checkout', $data);
    }
    ...
    public function detail(Request $request, $code){
        ...
        return view('Booking::admin/booking/booking-detail', $data);
    }
