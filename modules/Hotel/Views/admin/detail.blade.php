            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        @include('Hotel::admin.hotel.discountPricing')
...
@push('js')
    ...
    <script>
        jQuery(function($) {
            ...
            // hoteldiscount
            // if input discount price
            $(document).on("change", ".discountHotelPrice", function() {
                var discountType = $(".discountHotelType").val();
                var currentPrice = parseFloat($(".currentWithoutDiscountPrice").val()) || 0;
                var discountAmount = parseFloat($(this).val()) || 0;
                var percentageOfDiscount = (currentPrice * discountAmount) / 100;
                var afterDiscountAmount = discountType == "flat" ? currentPrice - discountAmount :
                    currentPrice - percentageOfDiscount;
                $(".afterDiscountAmount").val(afterDiscountAmount);
                console.log("joybangla", discountType, currentPrice, percentageOfDiscount,
                    afterDiscountAmount);
            })

            // if change discount type
            $(document).on("change", ".discountHotelType", function() {
                var discountType = $(this).val();
                var currentPrice = parseFloat($(".currentWithoutDiscountPrice").val()) || 0;
                var discountAmount = parseFloat($(".discountHotelPrice").val()) || 0;
                var percentageOfDiscount = (currentPrice * discountAmount) / 100;
                var afterDiscountAmount = discountType == "flat" ? currentPrice - discountAmount :
                    currentPrice - percentageOfDiscount;
                $(".afterDiscountAmount").val(afterDiscountAmount);
