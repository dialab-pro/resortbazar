    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            {{-- <div class="form-group @if (!is_default_lang()) d-none @endif">
                <label>
                    <input type="checkbox" name="enable_extra_price" @if (!empty($row->enable_extra_price)) checked @endif value="1"> {{__('Enable extra price')}}
                </label>
            </div>
            ...
            @if (is_default_lang() and (!empty(setting_item('hotel_allow_vendor_can_add_service_fee')) or is_admin()))
                ...
                <div class="form-group app_get_locale">
                    <label>
                        <input type="checkbox" name="enable_service_fee" @if (!empty($row->enable_service_fee)) checked @endif value="1">
