...
Route::post(config('hotel.hotel_route_prefix').'/getBookedDates','HotelController@getBookedDates')->name('hotel.getBookedDates');

Route::post(config('hotel.hotel_route_prefix').'/getRoomDataAvailability','HotelController@getRoomDataAvailability')->name('hotel.getRoomDataAvailability');
