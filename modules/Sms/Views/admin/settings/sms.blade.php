...
@if(is_default_lang())
    ...
    {{-- http://139.99.39.237/api/smsapi?api_key=vVHB28ijOAVgehrQBReO --}}

    <div class="row" data-condition="sms_driver:is(bd)">
        <div class="col-sm-4">
            <h3 class="form-group-title">
                {{__('Config BD Driver')}}
            </h3>
        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div data-condition="sms_driver:is(bd)">
{{-- SMS_BD_KEY
SMS_BD_FROM
SMS_BD_ACCOUNTSID --}}
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_bd_url" value="{{setting_item('sms_bd_url', config('sms.bd.url'))}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="">{{__("API key")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_bd_api_key" value="{{setting_item('sms_bd_api_key', config('sms.bd.key'))}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="">{{__("BD Account senderid")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_bd_account_sid" value="{{setting_item('sms_bd_account_sid', config('sms.bd.sid'))}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="">{{__("From")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_bd_api_from" value="{{setting_item('sms_bd_api_from', config('sms.bd.from'))}}">
                            </div>
                        </div>
