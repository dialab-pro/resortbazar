        ...
        <div class="content" style="justify-content: space-between;">
            ...
            <div class="header-left">
                <div class="bravo-menu">
                    {{-- @dd(generate_menu('primary')); --}}

                    <?php generate_menu('primary'); ?>
                    {{-- <li><a href="{{ route('boat.front.index') }}" class="btn btn-primary">HouseBoat</a></li> --}}
                </div>
                    ...
                    <ul class="topbar-items">
                        <li>
                            <a href="#" class="search_btn">
                                <i style="vertical-align: sub;" class="icofont-search"></i>
                            </a>
                        </li>

                        <li>
                            <a href="#" class="btn trip_btn">
                                Book Trip
                            </a>
                        </li>
                    </ul>
