    ...
    <div class="container">
        <div class="content">
            ...
            {{-- <div class="topbar-center">
                {!! clean(setting_item_with_lang("topbar_center_text")) !!}
            </div> --}}
            ...
            <div class="topbar-right">
                <ul class="topbar-items">
                    ...
                    @if(!Auth::check())
                    <li class="login-item" style="color: #fff;">
                    ...
                    <li class="signup-item" style="color: #fff;">
                    ...
                    <li class="login-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-user text-left">
                            ...
                            @if(is_enable_plan() )
                            <li class="menu-hr"><a href="{{route('user.plan')}}"><i class="fa fa-list-alt"></i>
                                    {{__("My plan")}}</a></li>
                            @endif
