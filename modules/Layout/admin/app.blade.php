...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Resort Bazar'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right">
                        {{date('Y')}} &copy; {{__('Resort Bazar BY')}} <a
                            href="{{__('https://resortbazar.com/')}}" target="_blank"
                        >{{__('Resort Bazar Team')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://resortbazar.com/')}}" target="_blank">{{__('About Us ss')}}</a>
                            <a href="{{__('https://resortbazar.com/')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
