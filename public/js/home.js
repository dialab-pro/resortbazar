jQuery(function ($) {
    $.fn.bravoAutocomplete = function (options) {
        ...
        return this.each(function () {
            ...
            main.append('<input type="text" id="search-input" class="search-input form-control" placeholder="Search..."><div class="bravo-autocomplete on-message"><div class="list-item"></div><div class="message">' + textLoading + '</div></div>');
            // main.append('<div class="bravo-autocomplete on-message"><div class="list-item"></div><div class="message">'+textLoading+'</div></div>');


            var search_input = document.getElementById('search-input');
            if (main.has(search_input).length != 0) {
            ...
            if (typeof options.url != 'undefined' && options.url) {
                ...
                main.find('.search-input').keyup(function (event) {
            ...
            main.find('.bravo-autocomplete').on('click', '.item', function () {
                ...
                if (id.length > 0 && text.length > 0) {
                    ...
                    text = trimFunc(text, ' ');
                    text = trimFunc(text, '-');
                    // main.find('.parent_text').val(text);
                    main.find('.parent_text').val(text).trigger("change");
                    // main.find('.child_id').val(id);
                ...
                setTimeout(function () {
                    main.find('.bravo-autocomplete').removeClass('show');
                    main.find('.search-input').attr('placeholder', '');
...
jQuery(function ($) {
    ...
    $(".bravo-list-testimonial").each(function () {
        $(this).find(".owl-carousel").owlCarousel({
            items: 2,
            loop: false,
            margin: 15,
    ...
    function updateGuestCountText(parent) {
        ...
        console.log("adult", adults, "children", children);
