    ...
    <div class="form-section">
        <div class="row">
            ...
            @if(is_enable_guest_checkout() && is_enable_registration())
                <div class="col-12 @if (empty($user)) d-none @endif">
                    <div class="form-group">
                        <label for="confirmRegister">
                            <input type="checkbox" name="confirmRegister" class="" @if (empty($user)) checked @endif id="confirmRegister" value="1">
            ...
            @if(is_enable_guest_checkout())
                <div class="col-12 @if (!empty($user)) d-none @endif" id="confirmRegisterContent">
                    <div class="row">
                        <div class="col-md-6" >
                            <div class="form-group ">
